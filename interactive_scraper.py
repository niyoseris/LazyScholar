#!/usr/bin/env python3
"""
Interactive wrapper for a generic web scraper with AI vision capabilities.
This script provides a user-friendly interface to scrape various websites without requiring technical knowledge.
"""
